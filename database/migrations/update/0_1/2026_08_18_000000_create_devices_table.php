...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (!Schema::hasTable('device_properties')) {
        ...
        if (!Schema::hasColumn('values', 'device_property_id')) {
        ...
        if (!Schema::hasColumn('values', 'value_integer')) {
            Schema::table('values', static function (Blueprint $table) {
                $table->integer('value_integer')->nullable()->after('value_boolean');
            });
        }

        if (!Schema::hasTable('device_identifiers')) {
