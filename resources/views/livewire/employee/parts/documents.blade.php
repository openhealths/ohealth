<div class="relative overflow-x-auto">
    <fieldset
        ...
        x-init="
            (() => {
                const initial = $wire.get('form.documents');
                documents = Array.isArray(initial) ? JSON.parse(JSON.stringify(initial)) : [];
            })();
            $watch('documents', (val) => {
                $wire.set('form.documents', Array.isArray(val) ? JSON.parse(JSON.stringify(val)) : [], false);
            });
        "
    >
        <legend class="legend">
                                ...
                                <div class="form-row-modal">
                                    <div>
                                        <label for="documentType" class="label-modal"
                                            >{{ __('forms.document_type') }}<span class="text-red-600"> *</span></label>
                                        <select
                                    ...
                                    <div>
                                        <label for="documentNumber" class="label-modal"
                                            >{{ __('forms.document_number') }}<span class="text-red-600">
                                                *</span
                                            ></label>
                                        <input
                                    ...
                                    <div>
                                        <label for="documentIssuedBy" class="label-modal"
                                            >{{ __('forms.issued_by') }}<span class="text-red-600"></span
                                        ></label>
                                        <input
                                    ...
                                    <div class="relative">
                                        ...
                                        <label for="documentIssuedAt" class="label-modal"
                                            >{{ __('forms.issued_at') }}<span class="text-red-600"> *</span></label>
                                        <input
                                    ...
                                    <button
                                        ...
                                        :class="{
                                            'opacity-50 cursor-not-allowed': ! (
                                                modalDocument.type &&
                                                modalDocument.number &&
                                                modalDocument.issuedAt
                                            ),
                                        }"
                                        :disabled="! (
                                            modalDocument.type &&
