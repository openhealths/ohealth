<div class="p-4 md:p-5 space-y-4">
    <p class="mb-3 text-lg text-gray-700 md:text-xl dark:text-gray-400">
        AGREEMENT TO TERMS
    <p>
    <p class="text-sm text-justify leading-relaxed text-gray-700 dark:text-gray-400">
        These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and <strong>OpenHealths LLC</strong>
        (“we,” “us” or “our”), concerning your access to and use of the <a href="https://openhealths.com.ua" class="font-small text-sm text-blue-600 dark:text-blue-500 hover:underline">openhealths.com.ua</a> website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”).
    </p>
    <p class="text-sm text-justify leading-relaxed text-gray-700 dark:text-gray-400">
    ...
    <p class="text-sm text-justify leading-relaxed text-gray-700 dark:text-gray-400">
        <em><strong>The Site is intended for users who are at least 18 years old. Persons under the age of 18 are not permitted to register for the Site.</strong></em>
    </p>
    ...
    <h2 class="mb-2 text-sm font-semibold text-gray-700 dark:text-white">By using the Site, you represent and warrant that:</h2>
    <ul class="max-w-full space-y-1 text-sm text-gray-700 list-disc list-inside dark:text-gray-400">
    ...
    <h2 class="mb-2 text-sm font-semibold text-gray-700 dark:text-white">As a user of the Site, you agree not to:</h2>
    <ol class="max-w-full space-y-1 text-sm text-gray-700 list-decimal list-inside dark:text-gray-400">
    ...
    <h2 class="mb-2 text-sm font-semibold text-gray-700 dark:text-white">When you create or make available any Contributions, you thereby represent and warrant that:</h2>
    <ol class="max-w-full space-y-1 text-sm text-gray-700 list-decimal list-inside dark:text-gray-400">
    ...
    <h2 class="mb-2 text-sm font-semibold text-gray-700 dark:text-white">When posting a review, you must comply with the following criteria:</h2>
    <ul class="max-w-full space-y-1 text-sm text-gray-700 list-disc list-inside dark:text-gray-400">
    ...
    <h5 class="text-xl font-bold text-gray-700 dark:text-white">Use License</h5>
    <p class="text-sm text-justify leading-relaxed text-gray-700 dark:text-gray-400">
    ...
    <h2 class="mb-2 text-sm font-semibold text-gray-700 dark:text-white">You shall not:</h2>
    <ul class="max-w-full space-y-1 text-sm text-gray-700 list-none list-inside dark:text-gray-400">
    ...
    <h2 class="mb-2 text-sm font-semibold text-gray-700 dark:text-white">We reserve the right, but not the obligation, to:</h2>
    <ul class="max-w-full space-y-1 text-sm text-gray-700 list-disc list-inside dark:text-gray-400">
    ...
    <p class="text-sm text-justify leading-relaxed text-gray-700 dark:text-gray-400">
        These Terms of Use and your use of the Site are governed by and construed in accordance with the laws of Ukraine applicable to agreements made and to be entirely performed within the local laws, without regard to its conflict of law principles.
    </p>
    <p class="mb-3 text-lg text-gray-700 md:text-xl dark:text-gray-400">
        CORRECTIONS
    </p>
    ...
    <h2 class="mb-2 text-sm font-semibold text-gray-700 dark:text-white">
        You agree to defend, indemnify, and hold us harmless, including our subsidiaries, affiliates, and all of our respective officers, agents, partners, and employees, from and against any loss, damage, liability, claim, or demand, including reasonable attorneys’ fees and expenses, made by any third party due to or arising out of:</h2>
    <ul class="max-w-full space-y-1 text-sm text-gray-700 list-disc list-inside dark:text-gray-400">
